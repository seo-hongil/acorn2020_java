...
public class MainClass07 {
	public static void main(String[] args) {
		...
		for(int i=0; i<list.size();i++) {
			MemberDto mm1=list.get(i);
			System.out.println(mm1.getNum()+"|"+mm1.getName()+"|"+mm1.getAddr());
		}
		//참조 테스트
		...
		String d=list.get(1).getName();
		
		String e=list.get(2).getAddr();
